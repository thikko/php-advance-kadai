...
if (isset($_POST['submit'])) {
  try {
    ...
    $sql_insert = '
      INSERT books (book_code, book_name, price, stock_quantity, genre_code)
      VALUES (:book_code, :book_name, :price, :stock_quantity, :gemre_code)
    ';
    ...
    <article class="registration">
      ...
      <form action="create.php" method="post" class="registration-form">
        <div>
          ...
          <select id="genre_code" name="gemre_code" required>
